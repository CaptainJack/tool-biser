...
object DataPairs {
	...
	val int = listOf(
		Int.MIN_VALUE
			.asBytes(0xFF, 0x80, 0x00, 0x00, 0x00), // -2147483648
		(-128)
			.asBytes(0xFF, 0xFF, 0xFF, 0xFF, 0x80),
		(-127)
			.asBytes(0xFF, 0xFF, 0xFF, 0xFF, 0x81),
		(-1)
			.asBytes(0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
		0
			.asBytes(0x00),
		127
			.asBytes(0x7F),
		...
		507
			.asBytes(0xFC, 0xFF),
		508
			.asBytes(0xFD, 0x00, 0x00),
		66_043
			.asBytes(0xFD, 0xFF, 0xFF),
		66_044
			.asBytes(0xFE, 0x00, 0x00, 0x00),
		16_843_259
			.asBytes(0xFE, 0xFF, 0xFF, 0xFF),
		16_843_260
			.asBytes(0xFF, 0x01, 0x01, 0x01, 0xFC),
		Int.MAX_VALUE
			.asBytes(0xFF, 0x7F, 0xFF, 0xFF, 0xFF) // 2147483647
	)
	
	val long = listOf(
		Long.MIN_VALUE
			.asBytes(0xFF, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00), // -9223372036854775808
		(-2147483648L)
			.asBytes(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, 0x00, 0x00, 0x00), // -2147483648
		(-128L)
			.asBytes(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x80),
		(-127L)
			.asBytes(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x81),
		(-1L)
			.asBytes(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
		0L
			.asBytes(0x00),
		127L
			.asBytes(0x7F),
		...
		16_843_259L
			.asBytes(0xFE, 0xFF, 0xFF, 0xFF),
		16_843_260L
			.asBytes(0xFF, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0xFC),
		2147483647L
			.asBytes(0xFF, 0x00, 0x00, 0x00, 0x00, 0x7F, 0xFF, 0xFF, 0xFF), // 2147483647
		Long.MAX_VALUE
			.asBytes(0xFF, 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF) // 9223372036854775807
	)
	...
	val bytes = listOf(
		bytes()
			.asBytes(0x00),
		bytes(-128, -1, 0, 1, 127, 255)
			.asBytes(0x06, 0x80, 0xFF, 0x00, 0x01, 0x7F, 0xFF)
	)
	...
	val enum = listOf(
		EnumStub.VALUE_1.asBytes(0x00),
		EnumStub.VALUE_2.asBytes(0x01)
	)
